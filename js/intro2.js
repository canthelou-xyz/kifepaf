PIXIScene.image("background", "img/OFC-App-V3-Jeu2-01.png", 180, 320);
PIXIScene.image("bandeau", "img/OFC-App-V3-Jeu2-04.png", 180, 200);
PIXIScene.image("txt1", "img/OFC-App-V3-Jeu2-05.png", 180, 180);
PIXIScene.image("txt2", "img/OFC-App-V3-Jeu2-06.png", 180, 230);
PIXIScene.image("txt3", "img/OFC-App-V3-Jeu2-07.png", 180, 320);
PIXIScene.image("fleche", "img/OFC-App-V3-Jeu2-08.png", 180, 390);
PIXIScene.image("carte", "img/OFC-App-V3-Jeu2-09.png", 180, 460);
